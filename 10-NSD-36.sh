...
set +x
curl --silent --remote-name-all --output-dir /tmp --header "Authorization: token $TOKEN" https://raw.githubusercontent.com/$GITHUB/eval-reg-keys/main/nginx/nginx-one-eval.{crt,key,jwt}
