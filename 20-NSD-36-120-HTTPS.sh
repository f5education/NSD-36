...
# copy files to nginx
    ...
    sudo scp /tmp/create_certs.sh nginx:/home/student/ssl/DASHBOARD/create_certs.sh
    sudo ssh nginx chmod +x /home/student/ssl/create_certs.sh
    sudo ssh nginx chmod +x /home/student/ssl/DASHBOARD/create_certs.sh
    ...
    sudo ssh nginx chown --recursive nginx:nginx /etc/nginx/ssl-configs
